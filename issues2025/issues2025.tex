...
\noindent
3 entries are marked ``\textbf{?}''.  In those cases the record stops before
...
\textcolor{stmit}{\textbf{M}} & Mitigated & 9 \\
...
\bottomrule
\end{tabular}
\caption{Status of the 46 issues identified in the 2025 camera operations
...
\foreach \m in {0,1,...,12} { \draw[issgrid,line width=0.4pt] (\m,-0.7) -- (\m,45.70); }
...
\fill[black!7] (9.000,-0.7) rectangle (9.613,45.70);
\draw[black!40,dashed,line width=0.4pt] (1.143,-0.7) -- (1.143,45.70);
\node[font=\scriptsize,text=black!55,anchor=west,rotate=38] at (1.143,-1.15) {on TEA};
\draw[black!40,dashed,line width=0.4pt] (2.161,-0.7) -- (2.161,45.70);
\node[font=\scriptsize,text=black!55,anchor=west,rotate=38] at (2.161,-1.15) {on TMA};
\draw[black!40,dashed,line width=0.4pt] (5.733,-0.7) -- (5.733,45.70);
\node[font=\scriptsize,text=black!55,anchor=west,rotate=38] at (5.733,-1.15) {First Look};
\draw[black!40,dashed,line width=0.4pt] (9.613,-0.7) -- (9.613,45.70);
...
\draw[issspan,line width=1.2pt] (4.355,3.00) -- (12.000,3.00);
\fill[issspan] (12.00,2.90) -- (12.00,3.10) -- (12.20,3.00) -- cycle;
\fill[stopn] (4.355,2.90) rectangle (8.233,3.10);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,5.00) {\hyperref[iss:CRYO-06]{CRYO-06}};
\draw[issspan,line width=1.2pt] (4.806,5.00) -- (9.484,5.00);
\fill[stmit] (4.756,4.89) rectangle (4.856,5.11);
\fill[stmit] (5.517,4.89) rectangle (5.617,5.11);
\fill[stmit] (9.323,4.89) rectangle (9.484,5.11);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,5.00) {M\,?};
\draw[issgrid,line width=0.6pt] (-2.6,5.50) -- (12.9,5.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,6.00) {\hyperref[iss:DYN-01]{DYN-01}};
\draw[issspan,line width=1.2pt] (0.548,6.00) -- (12.000,6.00);
\fill[issspan] (12.00,5.89) -- (12.00,6.11) -- (12.20,6.00) -- cycle;
\fill[stopn] (0.498,5.89) rectangle (0.598,6.11);
\fill[stopn] (2.611,5.89) rectangle (2.711,6.11);
\fill[stopn] (5.017,5.89) rectangle (5.117,6.11);
\fill[stopn] (7.273,5.89) rectangle (7.373,6.11);
\fill[stopn] (9.853,5.89) rectangle (9.953,6.11);
\fill[stopn] (10.583,5.89) rectangle (10.683,6.11);
\fill[stopn] (11.450,5.89) rectangle (11.550,6.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,7.00) {\hyperref[iss:DYN-02]{DYN-02}};
\draw[issspan,line width=1.2pt] (1.714,7.00) -- (12.000,7.00);
\fill[issspan] (12.00,6.89) -- (12.00,7.11) -- (12.20,7.00) -- cycle;
\fill[stopn] (1.714,6.89) rectangle (1.821,7.11);
\fill[stopn] (3.283,6.89) rectangle (3.383,7.11);
\fill[stopn] (6.918,6.89) rectangle (7.018,7.11);
\fill[stopn] (11.627,6.89) rectangle (11.727,7.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,8.00) {\hyperref[iss:DYN-04]{DYN-04}};
\draw[issspan,line width=1.2pt] (5.433,8.00) -- (12.000,8.00);
\fill[issspan] (12.00,7.89) -- (12.00,8.11) -- (12.20,8.00) -- cycle;
\fill[stopn] (5.400,7.89) rectangle (5.500,8.11);
\fill[stopn] (7.710,7.89) rectangle (7.935,8.11);
\fill[stopn] (10.300,7.89) rectangle (10.667,8.11);
\fill[stopn] (11.418,7.89) rectangle (11.518,8.11);
\node[font=\scriptsize\bfseries,text=white,fill=stopn,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,8.00) {O};
\draw[issgrid,line width=0.6pt] (-2.6,8.50) -- (12.9,8.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,9.00) {\hyperref[iss:GLY-01]{GLY-01}};
\draw[issspan,line width=1.2pt] (3.900,9.00) -- (12.000,9.00);
\fill[issspan] (12.00,8.89) -- (12.00,9.11) -- (12.20,9.00) -- cycle;
\fill[stres] (3.883,8.89) rectangle (3.983,9.11);
\fill[stres] (5.100,8.89) rectangle (5.333,9.11);
\fill[stres] (6.047,8.89) rectangle (6.147,9.11);
\fill[stres] (6.579,8.89) rectangle (6.679,9.11);
\fill[stres] (7.853,8.89) rectangle (7.953,9.11);
\fill[stres] (8.000,8.89) rectangle (8.133,9.11);
\fill[stres] (9.144,8.89) rectangle (9.244,9.11);
\fill[stres] (10.083,8.89) rectangle (10.183,9.11);
\fill[stres] (10.833,8.89) rectangle (10.933,9.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,10.00) {\hyperref[iss:PCS-01]{PCS-01}};
\draw[issspan,line width=1.2pt] (2.871,10.00) -- (7.323,10.00);
\fill[stres] (2.837,9.89) rectangle (2.937,10.11);
\fill[stres] (3.067,9.89) rectangle (3.167,10.11);
\fill[stres] (3.233,9.89) rectangle (3.333,10.11);
\fill[stres] (7.273,9.89) rectangle (7.373,10.11);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,10.00) {R};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,11.00) {\hyperref[iss:PCS-02]{PCS-02}};
\draw[issspan,line width=1.2pt] (2.871,11.00) -- (12.000,11.00);
\fill[issspan] (12.00,10.89) -- (12.00,11.11) -- (12.20,11.00) -- cycle;
\fill[stopn] (2.837,10.89) rectangle (2.937,11.11);
\fill[stopn] (5.966,10.89) rectangle (6.066,11.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,12.00) {\hyperref[iss:PWR-01]{PWR-01}};
\draw[issspan,line width=1.2pt] (1.857,12.00) -- (12.000,12.00);
\fill[issspan] (12.00,11.89) -- (12.00,12.11) -- (12.20,12.00) -- cycle;
\fill[stopn] (1.843,11.89) rectangle (1.943,12.11);
\fill[stopn] (3.883,11.89) rectangle (3.983,12.11);
\fill[stopn] (4.595,11.89) rectangle (4.695,12.11);
\fill[stopn] (5.100,11.89) rectangle (5.333,12.11);
\fill[stopn] (6.047,11.89) rectangle (6.147,12.11);
\fill[stopn] (6.579,11.89) rectangle (6.679,12.11);
\fill[stopn] (7.323,11.89) rectangle (7.484,12.11);
\fill[stopn] (7.885,11.89) rectangle (7.985,12.11);
\fill[stopn] (8.000,11.89) rectangle (8.133,12.11);
\fill[stopn] (9.144,11.89) rectangle (9.244,12.11);
\fill[stopn] (10.083,11.89) rectangle (10.183,12.11);
\fill[stopn] (10.817,11.89) rectangle (10.917,12.11);
\node[font=\scriptsize\bfseries,text=white,fill=stopn,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,12.00) {O};
\draw[issgrid,line width=0.6pt] (-2.6,12.50) -- (12.9,12.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,13.00) {\hyperref[iss:AIR-01]{AIR-01}};
\draw[issspan,line width=1.2pt] (1.929,13.00) -- (9.226,13.00);
\fill[stmit] (1.879,12.89) rectangle (1.979,13.11);
\fill[stmit] (5.400,12.89) rectangle (5.500,13.11);
\fill[stmit] (7.645,12.89) rectangle (7.935,13.11);
\fill[stmit] (9.160,12.89) rectangle (9.260,13.11);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,13.00) {M};
\draw[issgrid,line width=0.6pt] (-2.6,13.50) -- (12.9,13.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,14.00) {\hyperref[iss:FP-01]{FP-01}};
\draw[issspan,line width=1.2pt] (3.200,14.00) -- (11.290,14.00);
\fill[stwrk] (3.167,13.89) rectangle (3.267,14.11);
\fill[stwrk] (3.400,13.89) rectangle (3.500,14.11);
\fill[stwrk] (3.733,13.89) rectangle (3.833,14.11);
\fill[stwrk] (4.240,13.89) rectangle (4.340,14.11);
\fill[stwrk] (5.067,13.89) rectangle (5.167,14.11);
\fill[stwrk] (5.800,13.89) rectangle (5.933,14.11);
\fill[stwrk] (6.418,13.89) rectangle (6.518,14.11);
\fill[stwrk] (7.355,13.89) rectangle (7.645,14.11);
\fill[stwrk] (9.387,13.89) rectangle (9.613,14.11);
\fill[stwrk] (11.208,13.89) rectangle (11.308,14.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,15.00) {\hyperref[iss:FP-02]{FP-02}};
\draw[issspan,line width=1.2pt] (3.033,15.00) -- (3.767,15.00);
\fill[stwrk] (2.983,14.89) rectangle (3.083,15.11);
\fill[stwrk] (3.400,14.89) rectangle (3.500,15.11);
\fill[stwrk] (3.717,14.89) rectangle (3.817,15.11);
\node[font=\scriptsize\bfseries,text=white,fill=stwrk,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,15.00) {W};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,16.00) {\hyperref[iss:FP-03]{FP-03}};
\draw[issspan,line width=1.2pt] (4.129,16.00) -- (9.774,16.00);
\fill[stmit] (4.079,15.89) rectangle (4.179,16.11);
\fill[stmit] (4.305,15.89) rectangle (4.405,16.11);
\fill[stmit] (5.900,15.89) rectangle (6.000,16.11);
\fill[stmit] (8.017,15.89) rectangle (8.117,16.11);
\fill[stmit] (9.613,15.89) rectangle (9.774,16.11);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,16.00) {M};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,17.00) {\hyperref[iss:FP-04]{FP-04}};
\draw[issspan,line width=1.2pt] (3.167,17.00) -- (4.290,17.00);
\fill[stwrk] (3.117,16.89) rectangle (3.217,17.11);
\fill[stwrk] (3.483,16.89) rectangle (3.583,17.11);
\fill[stwrk] (3.950,16.89) rectangle (4.050,17.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,18.00) {\hyperref[iss:FP-05]{FP-05}};
\draw[issspan,line width=1.2pt] (3.933,18.00) -- (9.645,18.00);
\fill[stwrk] (3.900,17.89) rectangle (4.000,18.11);
\fill[stwrk] (4.240,17.89) rectangle (4.340,18.11);
\fill[stwrk] (9.579,17.89) rectangle (9.679,18.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,19.00) {\hyperref[iss:FP-06]{FP-06}};
\draw[issspan,line width=1.2pt] (0.645,19.00) -- (12.000,19.00);
\fill[issspan] (12.00,18.89) -- (12.00,19.11) -- (12.20,19.00) -- cycle;
\fill[stopn] (0.611,18.89) rectangle (0.711,19.11);
\fill[stopn] (3.883,18.89) rectangle (3.983,19.11);
...
\draw[issgrid,line width=0.6pt] (-2.6,19.50) -- (12.9,19.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,20.00) {\hyperref[iss:FW-01]{FW-01}};
\draw[issspan,line width=1.2pt] (7.323,20.00) -- (7.710,20.00);
\fill[stres] (7.273,19.89) rectangle (7.373,20.11);
\fill[stres] (7.627,19.89) rectangle (7.727,20.11);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,20.00) {R};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,21.00) {\hyperref[iss:FW-02]{FW-02}};
\draw[issspan,line width=1.2pt] (9.387,21.00) -- (12.000,21.00);
\fill[issspan] (12.00,20.89) -- (12.00,21.11) -- (12.20,21.00) -- cycle;
\fill[stopn] (9.385,20.89) rectangle (9.485,21.11);
\fill[stopn] (9.853,20.89) rectangle (9.953,21.11);
\fill[stopn] (10.050,20.89) rectangle (10.150,21.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,22.00) {\hyperref[iss:FW-03]{FW-03}};
\draw[issspan,line width=1.2pt] (9.258,22.00) -- (12.000,22.00);
\fill[issspan] (12.00,21.89) -- (12.00,22.11) -- (12.20,22.00) -- cycle;
\fill[stopn] (9.258,21.89) rectangle (9.613,22.11);
\fill[stopn] (11.208,21.89) rectangle (11.308,22.11);
\fill[stopn] (11.385,21.89) rectangle (11.485,22.11);
\fill[stopn] (11.821,21.89) rectangle (11.921,22.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,23.00) {\hyperref[iss:FW-04]{FW-04}};
\draw[issspan,line width=1.2pt] (3.833,23.00) -- (12.000,23.00);
\fill[issspan] (12.00,22.89) -- (12.00,23.11) -- (12.20,23.00) -- cycle;
\fill[stres] (3.817,22.89) rectangle (3.917,23.11);
\fill[stres] (5.267,22.89) rectangle (5.833,23.11);
\fill[stres] (10.717,22.89) rectangle (10.817,23.11);
\fill[stres] (11.208,22.89) rectangle (11.308,23.11);
\fill[stres] (11.385,22.89) rectangle (11.485,23.11);
\fill[stres] (11.821,22.89) rectangle (11.921,23.11);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,23.00) {R};
\draw[issgrid,line width=0.6pt] (-2.6,23.50) -- (12.9,23.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,24.00) {\hyperref[iss:DAQ-01]{DAQ-01}};
\draw[issspan,line width=1.2pt] (2.742,24.00) -- (12.000,24.00);
\fill[issspan] (12.00,23.89) -- (12.00,24.11) -- (12.20,24.00) -- cycle;
\fill[stopn] (2.724,23.89) rectangle (2.824,24.11);
\fill[stopn] (3.567,23.89) rectangle (3.667,24.11);
\fill[stopn] (4.000,23.89) rectangle (4.194,24.11);
\fill[stopn] (7.498,23.89) rectangle (7.598,24.11);
\fill[stopn] (7.789,23.89) rectangle (7.889,24.11);
\fill[stopn] (8.433,23.89) rectangle (8.567,24.11);
\fill[stopn] (9.224,23.89) rectangle (9.324,24.11);
\fill[stopn] (9.563,23.89) rectangle (9.663,24.11);
\fill[stopn] (10.717,23.89) rectangle (10.817,24.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,25.00) {\hyperref[iss:DAQ-02]{DAQ-02}};
\draw[issspan,line width=1.2pt] (9.290,25.00) -- (9.387,25.00);
\fill[stmit] (9.289,24.89) rectangle (9.389,25.11);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,25.00) {M};
\draw[issgrid,line width=0.6pt] (-2.6,25.50) -- (12.9,25.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,26.00) {\hyperref[iss:CCS-01]{CCS-01}};
\draw[issspan,line width=1.2pt] (4.000,26.00) -- (12.000,26.00);
\fill[issspan] (12.00,25.89) -- (12.00,26.11) -- (12.20,26.00) -- cycle;
\fill[stopn] (4.000,25.89) rectangle (4.129,26.11);
\fill[stopn] (6.305,25.89) rectangle (6.405,26.11);
\fill[stopn] (8.167,25.89) rectangle (8.500,26.11);
\fill[stopn] (9.918,25.89) rectangle (10.018,26.11);
\fill[stopn] (9.983,25.89) rectangle (10.083,26.11);
\fill[stopn] (10.667,25.89) rectangle (10.767,26.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,27.00) {\hyperref[iss:CCS-02]{CCS-02}};
\draw[issspan,line width=1.2pt] (3.500,27.00) -- (6.097,27.00);
\fill[stres] (3.500,26.89) rectangle (3.600,27.11);
\fill[stres] (5.733,26.89) rectangle (6.097,27.11);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,27.00) {R};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,28.00) {\hyperref[iss:CCS-03]{CCS-03}};
\draw[issspan,line width=1.2pt] (6.387,28.00) -- (12.000,28.00);
\fill[issspan] (12.00,27.89) -- (12.00,28.11) -- (12.20,28.00) -- cycle;
\fill[stopn] (6.387,27.89) rectangle (6.871,28.11);
\fill[stopn] (10.217,27.89) rectangle (10.317,28.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,29.00) {\hyperref[iss:CCS-04]{CCS-04}};
\draw[issspan,line width=1.2pt] (1.857,29.00) -- (2.097,29.00);
\fill[stmit] (1.857,28.89) rectangle (2.097,29.11);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,29.00) {M};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,30.00) {\hyperref[iss:CCS-05]{CCS-05}};
\draw[issspan,line width=1.2pt] (10.633,30.00) -- (12.000,30.00);
\fill[issspan] (12.00,29.89) -- (12.00,30.11) -- (12.20,30.00) -- cycle;
\fill[stopn] (10.583,29.89) rectangle (10.683,30.11);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,31.00) {\hyperref[iss:CCS-06]{CCS-06}};
\draw[issspan,line width=1.2pt] (1.500,31.00) -- (12.000,31.00);
\fill[issspan] (12.00,30.89) -- (12.00,31.11) -- (12.20,31.00) -- cycle;
\fill[stopn] (1.500,30.89) rectangle (1.607,31.11);
\fill[stopn] (3.167,30.89) rectangle (3.267,31.11);
\fill[stopn] (4.418,30.89) rectangle (4.518,31.11);
\fill[stopn] (5.150,30.89) rectangle (5.250,31.11);
\fill[stopn] (7.323,30.89) rectangle (7.581,31.11);
\fill[stopn] (9.289,30.89) rectangle (9.389,31.11);
\fill[stopn] (9.983,30.89) rectangle (10.083,31.11);
\fill[stopn] (10.667,30.89) rectangle (10.767,31.11);
\node[font=\scriptsize\bfseries,text=white,fill=stopn,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,31.00) {O};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,32.00) {\hyperref[iss:CCS-07]{CCS-07}};
\draw[issspan,line width=1.2pt] (10.000,32.00) -- (10.767,32.00);
\fill[stmit] (9.950,31.89) rectangle (10.050,32.10);
\fill[stmit] (10.667,31.89) rectangle (10.767,32.10);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,33.00) {\hyperref[iss:CCS-08]{CCS-08}};
\draw[issspan,line width=1.2pt] (2.677,33.00) -- (12.000,33.00);
\fill[issspan] (12.00,32.90) -- (12.00,33.10) -- (12.20,33.00) -- cycle;
\fill[stopn] (2.627,32.90) rectangle (2.727,33.10);
\fill[stopn] (9.144,32.90) rectangle (9.244,33.10);
...
\draw[issgrid,line width=0.6pt] (-2.6,33.50) -- (12.9,33.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,34.00) {\hyperref[iss:SHT-01]{SHT-01}};
\draw[issspan,line width=1.2pt] (2.742,34.00) -- (9.645,34.00);
\fill[stres] (2.708,33.90) rectangle (2.808,34.10);
\fill[stres] (5.000,33.90) rectangle (5.100,34.10);
\fill[stres] (9.516,33.90) rectangle (9.645,34.10);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,35.00) {\hyperref[iss:SHT-02]{SHT-02}};
\draw[issspan,line width=1.2pt] (5.100,35.00) -- (10.633,35.00);
\fill[stmit] (5.100,34.90) rectangle (5.333,35.10);
\fill[stmit] (10.017,34.90) rectangle (10.117,35.10);
\fill[stmit] (10.583,34.90) rectangle (10.683,35.10);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,35.00) {M};
\draw[issgrid,line width=0.6pt] (-2.6,35.50) -- (12.9,35.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,36.00) {\hyperref[iss:FES-01]{FES-01}};
\draw[issspan,line width=1.2pt] (4.032,36.00) -- (12.000,36.00);
\fill[issspan] (12.00,35.90) -- (12.00,36.10) -- (12.20,36.00) -- cycle;
\fill[stopn] (4.032,35.90) rectangle (4.935,36.10);
\fill[stopn] (5.650,35.90) rectangle (5.750,36.10);
\fill[stopn] (6.161,35.90) rectangle (6.387,36.10);
\fill[stopn] (6.710,35.90) rectangle (6.903,36.10);
\fill[stopn] (7.127,35.90) rectangle (7.227,36.10);
\fill[stopn] (9.000,35.90) rectangle (9.613,36.10);
\fill[stopn] (10.367,35.90) rectangle (10.667,36.10);
\fill[stopn] (11.226,35.90) rectangle (11.387,36.10);
\node[font=\scriptsize\bfseries,text=white,fill=stopn,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,36.00) {O};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,37.00) {\hyperref[iss:FES-02]{FES-02}};
\draw[issspan,line width=1.2pt] (3.400,37.00) -- (3.800,37.00);
\fill[stres] (3.400,36.90) rectangle (3.800,37.10);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,37.00) {R};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,38.00) {\hyperref[iss:FES-03]{FES-03}};
\draw[issspan,line width=1.2pt] (1.429,38.00) -- (12.000,38.00);
\fill[issspan] (12.00,37.90) -- (12.00,38.10) -- (12.20,38.00) -- cycle;
\fill[stopn] (1.396,37.90) rectangle (1.496,38.10);
\fill[stopn] (2.742,37.90) rectangle (2.903,38.10);
\fill[stopn] (3.633,37.90) rectangle (3.733,38.10);
\fill[stopn] (8.033,37.90) rectangle (8.133,38.10);
\fill[stopn] (11.337,37.90) rectangle (11.437,38.10);
...
\draw[issgrid,line width=0.6pt] (-2.6,38.50) -- (12.9,38.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,39.00) {\hyperref[iss:OPT-01]{OPT-01}};
\draw[issspan,line width=1.2pt] (3.533,39.00) -- (9.677,39.00);
\fill[stwrk] (3.533,38.90) rectangle (3.933,39.10);
\fill[stwrk] (4.161,38.90) rectangle (4.355,39.10);
\fill[stwrk] (5.217,38.90) rectangle (5.317,39.10);
\fill[stwrk] (5.683,38.90) rectangle (5.783,39.10);
\fill[stwrk] (8.117,38.90) rectangle (8.217,39.10);
\fill[stwrk] (8.633,38.90) rectangle (8.733,39.10);
\fill[stwrk] (9.627,38.90) rectangle (9.727,39.10);
\node[font=\scriptsize\bfseries,text=white,fill=stwrk,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,39.00) {W};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,40.00) {\hyperref[iss:OPT-02]{OPT-02}};
\draw[issspan,line width=1.2pt] (3.600,40.00) -- (3.633,40.00);
\fill[sttra] (3.567,39.90) rectangle (3.667,40.10);
\node[font=\scriptsize\bfseries,text=white,fill=sttra,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,40.00) {T};
\draw[issgrid,line width=0.6pt] (-2.6,40.50) -- (12.9,40.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,41.00) {\hyperref[iss:MEC-01]{MEC-01}};
\draw[issspan,line width=1.2pt] (0.871,41.00) -- (1.107,41.00);
\fill[stres] (0.871,40.90) rectangle (1.107,41.10);
\node[font=\scriptsize\bfseries,text=white,fill=stres,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,41.00) {R};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,42.00) {\hyperref[iss:MEC-02]{MEC-02}};
\draw[issspan,line width=1.2pt] (1.607,42.00) -- (12.000,42.00);
\fill[issspan] (12.00,41.90) -- (12.00,42.10) -- (12.20,42.00) -- cycle;
\fill[stopn] (1.557,41.90) rectangle (1.657,42.10);
\fill[stopn] (7.789,41.90) rectangle (7.889,42.10);
\fill[stopn] (9.065,41.90) rectangle (9.258,42.10);
...
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,43.00) {\hyperref[iss:MEC-03]{MEC-03}};
\draw[issspan,line width=1.2pt] (7.097,43.00) -- (12.000,43.00);
\fill[issspan] (12.00,42.90) -- (12.00,43.10) -- (12.20,43.00) -- cycle;
\fill[stopn] (7.097,42.90) rectangle (7.355,43.10);
\fill[stopn] (8.150,42.90) rectangle (8.250,43.10);
\node[font=\scriptsize\bfseries,text=white,fill=stopn,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,43.00) {O};
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,44.00) {\hyperref[iss:MEC-04]{MEC-04}};
\draw[issspan,line width=1.2pt] (0.645,44.00) -- (0.677,44.00);
\fill[stwrk] (0.611,43.90) rectangle (0.711,44.10);
\node[font=\scriptsize\bfseries,text=white,fill=stwrk,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,44.00) {W};
\draw[issgrid,line width=0.6pt] (-2.6,44.50) -- (12.9,44.50);
\node[font=\scriptsize\ttfamily,anchor=east] at (-0.12,45.00) {\hyperref[iss:IT-01]{IT-01}};
\draw[issspan,line width=1.2pt] (1.179,45.00) -- (11.484,45.00);
\fill[stmit] (1.179,44.90) rectangle (1.429,45.10);
\fill[stmit] (3.183,44.90) rectangle (3.283,45.10);
\fill[stmit] (4.111,44.90) rectangle (4.211,45.10);
\fill[stmit] (5.050,44.90) rectangle (5.150,45.10);
\fill[stmit] (6.402,44.90) rectangle (6.502,45.10);
\fill[stmit] (7.773,44.90) rectangle (7.873,45.10);
\fill[stmit] (8.900,44.90) rectangle (9.000,45.10);
\fill[stmit] (9.192,44.90) rectangle (9.292,45.10);
\fill[stmit] (10.500,44.90) rectangle (10.600,45.10);
\fill[stmit] (11.434,44.90) rectangle (11.534,45.10);
\node[font=\scriptsize\bfseries,text=white,fill=stmit,rounded corners=1pt,inner sep=1.2pt,minimum width=0.30cm,anchor=west] at (12.35,45.00) {M};
\end{tikzpicture}%
\endgroup
...
\item[CRYO-04]\label{iss:CRYO-04} \textbf{Capillary clogs (Cryo 1 cleared over months, Cryo 3 lost, Cryo 4 self-cleared).}
  \emph{First to last mention 2025-05-12 to 2025-12-11; status \textcolor{stopn}{\textbf{Open}}.}
  The first of the three is Cryo~1, and it is the one that was never named as a clog at the time.  The circuit is believed to have been clogged by the recovery activity of around May~10, after which its heat-exchanger return temperature ran persistently low --- the condition registered separately as CRYO-02, since what was managed nightly was the dew-point risk rather than the clog behind it.  From May~12 the circuit was power-cycled repeatedly, at times daily and of order thirty to sixty times in all, in the hope of shifting the obstruction; the liquid-line isolation valve was throttled and refrigerant removed in early June.  No one of those can be credited with the result.  The circuit came back gradually --- the heat-exchanger return temperature was above zero again by early July, Cryo~1 was called partially recovered in early August, and on September~3 it was taken out of the dome-closure decision criteria --- and by the middle of October it was being spoken of in the past tense, as the precedent for how long a clog can take to clear: ``Cryo~2 unclogged in 6 hours.  Cryo~1 unclogged in months.''  It was not worked on during the October shutdown; the filter-dryer replacements of that campaign excluded it, and no charge replacement on it is recorded.  What the circuit is left with is a heat-exchanger return temperature that still runs low in humid conditions, which is CRYO-02 and was being accepted rather than resolved in December.  Cryo~3 is the second, and it was set in motion by the nitrogen contamination of CRYO-06: the circuit had to be evacuated and recharged in the middle of the October shutdown, and it was on that recharge that it developed a clog --- the capillary is the suspected location --- that survived repeated power cycles, refrigerant additions and running the telescope horizontal; the circuit was given up on October~20 and the camera has run on five of six circuits since, and it was still out of service at year end.  The third, on the Cryo~4 capillary, developed in early December, drove cryo trim heat down to about 1\,W, and cleared spontaneously on the evening of December~10 without intervention.  Three clogs, three outcomes --- cleared over months, never cleared, cleared by itself in a day --- and no procedure that reliably prevents or clears one.  What was learned in October is the narrower lesson about admitting nitrogen (CRYO-06); the suggestion made at the time that a longer shutdown raises the chance of a clog at all is recorded but not established.
...
\caption{\textbf{PCS-02.} The chiller PLC panel during a restart attempt: stopped, with every error condition clear.  Nothing is reported as wrong, and the unit will still trip on low HFE flow when it is asked to start again --- which is why the restarts took about a dozen attempts over two days (2025-03-28, \#cam-operator).}
...
\caption{\textbf{PWR-01.} The chain of 30 August, in the order it happened.  Top: glycol input flow to the chiller collapsing when the generator trips, and the chiller outlet temperature stepping up as it goes --- ``No glycol flow to chiller.  Tripped.''  The cryo circuits go with it.  Bottom: the consequence some twenty minutes later --- cryostat and heat-exchanger pressure leaving $10^{-7}$\,Torr and rising past $1.1\times10^{-6}$, with the cryo plate warming from $-124$ towards $-113\,^{\circ}$C at about $0.6\,^{\circ}$C per minute.  The ion-pump shutdown limit was estimated to be fifteen minutes away when generator power came back (2025-08-30).}
