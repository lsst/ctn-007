...
This section organizes the 2025 LSSTCam operations record by
...
Appendix~\ref{sec:chronology-2025}.  The purpose of the organization is to
...
\noindent
Three entries are also marked with a ``\textbf{?}''.  In those cases the record stops before
...
long tail with no activity.  Those, together with the six Workaround issues, are the
...
\end{tikzpicture}%
\endgroup
\caption{Activity timeline in 2025 of the issues in the register.  A solid bar marks a period in
...
shutdown (October~20).  Absence of a bar means silence in the two channels,
